...
class data_SLIC(object):
    ...
    def SLIC_Process(self, img, n_segments):
        n_segments_init = n_segments
    ...
    def simple_superpixel(self, n_segments):
        Q, S, A, Seg = self.SLIC_Process(self.data, n_segments=n_segments)
        return Q, S, A, Seg
